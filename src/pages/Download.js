export function initDownload(container) {
  ...
  section.innerHTML = `
    <div class="max-w-3xl text-center px-4">
      <h2 class="text-4xl font-bold tracking-tight mb-6 text-neutral-950 dark:text-white">ダウンロード</h2>
      <p class="text-lg text-neutral-600 dark:text-neutral-400">最新バージョンのダウンロードリンクやシステム要件です。</p>
    </div>
  `;
