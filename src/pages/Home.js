export function initHome(container) {
  ...
  section.innerHTML = `
    <div class="max-w-3xl text-center px-4">
      <h2 class="text-4xl sm:text-6xl font-black tracking-tight mb-6 text-neutral-950 dark:text-white">SHINZUI ホーム</h2>
      <p class="text-lg text-neutral-600 dark:text-neutral-400">ここにホームページのメインビジュアルやイントロダクションが入ります。</p>
    </div>
  `;
